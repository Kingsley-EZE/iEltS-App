...
import com.example.ieltsapplication.databinding.FragmentIntermediateBinding
...
class IntermediateFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val recyclerInter = binding.recyclerInter
        recyclerInter.layoutManager = LinearLayoutManager(activity)

        val detailList = ArrayList<Details>()

        detailList.add(Details("Lesson #1", getString(R.string.details2),R.drawable.ic_quizimage))
        detailList.add(Details("Lesson #2", getString(R.string.details2),R.drawable.ic_quizimage))
